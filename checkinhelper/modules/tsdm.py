...
class tsdmCheckin(object):
    ...
    def get_update_cookie(cookie):
        return {'s_gkr8_682f_auth': extract_cookie('s_gkr8_682f_auth', cookie),
                's_gkr8_682f_sid': extract_cookie('s_gkr8_682f_sid', cookie),
                's_gkr8_682f_saltkey': extract_cookie('s_gkr8_682f_saltkey', cookie), }
